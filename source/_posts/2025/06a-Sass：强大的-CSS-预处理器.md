...
直到今天，我们也不能说 Sass 就已经过时了，没有必要了，它仍然是强大的预处理器，切始终要记得，它是 CSS 预处理器，发生作用的时间，终究比 CSS 代码提前了一个环节，即便 CSS 3 已经如此强大，但是配合 Sass 只能是如虎添翼，绝非多此一举。
